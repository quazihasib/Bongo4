...
public class UnCaughtException implements UncaughtExceptionHandler
{
    ...
    public void uncaughtException(Thread t, Throwable e) 
    {
        try 
        {
            ...
            Log.d(UnCaughtException.class.getName(),"Error while sendErrorMail" );
...
//            MainActivity.instance.finish();
            //MainActivity.instance.startActivity(new Intent(MainActivity.instance, MainActivity.class));
            
//            ActivityManager activityManager = (ActivityManager) MainActivity.instance.getSystemService(MainActivity.instance.ACTIVITY_SERVICE);
//            activityManager.killBackgroundProcesses("com.example.crashtest");
        }
